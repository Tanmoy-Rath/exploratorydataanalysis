...
```
+ <a href="http://groupware.les.inf.puc-rio.br/har">summarySCC_PM25.rds</a>????????????????
+ <a href="http://groupware.les.inf.puc-rio.br/work.jsf?p1=11201">Source_Classification_Code.rds</a>??????????
...
plot <- barplot(height = total_emissions$Emissions/1000, # dividing by 1000 converts y-axis to kilo-tons
                ...
                main=expression('Total PM'[2.5]*' emissions across United States in Kilo-tons'),col=c("#9403BE","#7903B8","#7903B8"))
...
plot <- barplot(height = total_emissions$Emissions,
                xlab="Time in years", ylab=expression('Baltimore City PM'[2.5]*' emissions in tons'),
                ylim=c(0,3800),
                names.arg = total_emissions$year,
                main=expression('Baltimore City PM'[2.5]*' emissions in tons'),col=c("#7903B8","#9403BE"))
...
This brings us to the end of the assignment which was answered sufficiently by plotting systems of R.